export const projects = [
  {
    ...
    detailedDescription: "A comprehensive student management system that allows administrators to perform full CRUD operations on student records, view detailed reports, and manage academic data efficiently.",
  ...
  },
  {
    ...
    detailedDescription: "An enterprise-grade employee management system with role-based access control. Enables HR and administrators to manage employee details, track attendance, and process payroll.",
  ...
  },
  {
    ...
    description: "Full-stack ISP management system with admin panel and user app supporting 200+ subscribers.",
  ...
  },
  {
    ...
    description: "Full-stack marketplace for 500+ users with authentication and order management.",
